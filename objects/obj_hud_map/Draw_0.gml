...
//	if (obj_mapplayer.boxselection > 0) {
...
//			//Set alpha of item
//			alpha[i] = (obj_mapplayer.boxselection == i) ? lerp(alpha[i], 1, 0.2) : lerp(alpha[i], 0.5, 0.2);
//			scale[i] = (obj_mapplayer.boxselection == i) ? lerp(scale[i], 1.5, 0.2) : lerp(scale[i], 1, 0.2);
